...
from app.api import session_routes, positioning_routes, debug_routes
...
app.include_router(positioning_routes.router, prefix="/api/v1/positioning", tags=["positioning"])
